...
function getAllServices() {
    ...
    return stored ? JSON.parse(stored) : serviceData;
}
function getServiceById(id) { return getAllServices().find(s => s.id === id); }
function getServiceBySlug(slug) { return getAllServices().find(s => s.slug === slug); }